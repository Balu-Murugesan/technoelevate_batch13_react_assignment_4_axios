...
export default class Account extends Component {
    ...
    componentDidMount(){
        const url=`https://axios-formhandling-default-rtdb.firebaseio.com/accounts.json`;
    ...
    deletedata=(data)=>{
        console.log(data);
        const url=`https://axios-formhandling-default-rtdb.firebaseio.com/accounts/${data.id}.json`
    ...
    updatedata=()=>{
        ...
        const url=`https://axios-formhandling-default-rtdb.firebaseio.com/accounts/${this.state.id}.json`
        const {firstname,lastname,email,phone,address,bike,city,states,zip}=this.state
        const account={firstname,lastname,email,phone,address,bike,city,states,zip}
        console.log(account);//updated record
        ...
        console.log(updatedRecords);//have all records
        this.setState({
          show: false,
    ...
    render() {
        return (
            ...
            <thead>
                ...
                <th scope="col" className="text-danger">Bike Number</th>
            ...
            <tbody>
                ...
                <Modal show={this.state.show} onHide={this.handleclose} animation={false}>
                    ...
                    <Modal.Body>
                        ...
                        <div className="form-group">
                            <label htmlFor="inputAddress2"  className="text-danger font-weight-bolder">Bike Name</label>
                            <input type="text" className="form-control" id="inputAddress2" placeholder="Enter the Bike Name" name="bike" value={this.state.bike} onChange={this.handleChange}/>
                        </div>
                        <div className="form-row">
                            <div className="form-group col-md-6">
